...
export const translations = {
    es: {
        ...
        about_p1: "Fullstack Web Developer apasionada por crear soluciones web que combinen funcionalidad sólida con diseño cuidado.",
        ...
        error_title: "¡Ups! Te has perdido",
        error_p: "La página que buscas no existe o ha sido movida a otro rincón del servidor.",
        exp_p_0: "Desarrollo fullstack de aplicación web EventOS utilizando Node.js, React, Express, apis para manejo de Google Calendar, Supabase (postgreSQL) y Vercel.",
    ...
    en: {
        ...
        about_p1: "Fullstack Web Developer passionate about creating web solutions that combine solid functionality with thoughtful design.",
        ...
        error_title: "Oops! You're lost",
        error_p: "The page you're looking for doesn't exist or has been moved to another part of the server.",
        exp_p_0: "Fullstack development of the EventOS web application using Node.js, React, Express, Google Calendar APIs, Supabase (postgreSQL), and Vercel.",
        exp_p_1: "Fullstack development of the GoodHabit web app using Node.js, React, Supabase (postgreSQL), and Vercel.",
        exp_p_2: "Fullstack development of a web application with Node.js and React, dedicated to corporate environmental training.",
